...
import com.pluralsight.calcengine.CalculatorHelper;
...
//        useCalculateHelper();
    ...
    static void useMathEquation() {
        System.out.println(" ");
        System.out.println("Using constructor with 3 arguments");
        System.out.println(" ");
        ...
        System.out.println(" ");
        System.out.println("Using constructor with 1 argument");
        System.out.println(" ");
    ...
    static void useCalculatorBase() {
        System.out.println(" ");
        System.out.println("Using Calculator Base (abstract class concept)");
        System.out.println(" ");
    ...
    static void useCalculateHelper() {
        System.out.println(" ");
        System.out.println("Using Calculator Helper");
        System.out.println(" ");
